...
square_weights_train = os.path.join(CVROOT, "weights/classifier/classifier_{epoch:02d}-{val_loss:.2f}.hdf5")
board_weights = os.path.join(CVROOT, "weights/best_weights_board.hdf5")
board_weights_train = os.path.join(CVROOT, "weights/extractor/extractor_{epoch:02d}-{val_dice_coeff:.2f}.hdf5")
